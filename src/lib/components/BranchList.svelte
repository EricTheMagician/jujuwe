...
<div class="p-3 bg-[var(--color-bg-secondary)] rounded-lg min-w-[200px]">
  <div class="flex justify-between items-center mb-3">
    ...
    <button class="p-1 rounded bg-transparent border-none cursor-pointer text-[var(--color-text-secondary)] flex items-center justify-center hover:bg-[var(--color-bg-hover)] hover:text-[var(--color-text-primary)]" onclick={handleRefresh} title="Refresh branches">
